...
**Compatibility (book draft D).** Shared math is `flux_hopf_lib 0.3.1`. Renderer is `qga_gpu@b9c9994`. Engine is `qga_engine@7e7866b`. No engine/gpu `v0.1.0` tags yet. Do not float `main`.
