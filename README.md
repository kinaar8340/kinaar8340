...
**Compatibility (book draft D).** Shared math is `flux_hopf_lib 0.3.1`. Renderer is `qga_gpu@b9c9994` (`qga_engine` pins that sha). Path pins still legal locally. No engine/gpu `v0.1.0` tags yet.
